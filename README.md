...
- [x] Alert Controllers implemented to prevent a user from registering or logging in incorrectly.
- [x] Loading icon while logging on or registering

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. I'd like to add push notifications to my app.
2. I want to implement a settings screen to allow users to change text size, dark mode, etc.
